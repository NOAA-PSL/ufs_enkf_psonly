...
cat <<EOF > enkf.nml
 &nam_enkf
  ...
  lobsdiag_forenkf=${lobsdiag_forenkf},write_spread_diag=.false.,netcdf_diag=.true.,write_ensmean=${write_ensmean},
  sortinc=$sortinc,nhr_anal=$iaufhrs,nhr_state=$enkfstatefhrs,getkf=$getkf,taperanalperts=.true.,
